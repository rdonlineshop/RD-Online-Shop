...
class ResortPartnerRoomsPage extends StatefulWidget {
  const ResortPartnerRoomsPage({super.key});

  @override
  State<ResortPartnerRoomsPage> createState() =>
      _ResortPartnerRoomsPageState();
}

class _ResortPartnerRoomsPageState
    extends State<ResortPartnerRoomsPage> {
  ...
  Future<void> _openEditor({
    ...
    if (resort['_exists'] != true) {
      _message(
        'Please create Resort Profile first.',
      );
      return;
    }

    if (resort['isApproved'] != true ||
        resort['isActive'] != true) {
      _message(
        'Resort must be approved and active '
