...
class AdminResortManagementPage
  ...
  @override
  State<AdminResortManagementPage>
      createState() =>
          _AdminResortManagementPageState();
}

class _AdminResortManagementPageState
    extends State<AdminResortManagementPage> {
    ...
    return StreamBuilder<
      ...
      builder: (
        ...
        if (snapshot.hasError) {
          return Center(
            child: Text(
              'Could not load resort bookings.\n'
              '${snapshot.error}',
              textAlign:
                  TextAlign.center,
            ),
