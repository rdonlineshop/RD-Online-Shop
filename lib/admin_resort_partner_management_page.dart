...
class AdminResortPartnerManagementPage extends StatefulWidget {
  const AdminResortPartnerManagementPage({super.key});

  @override
  State<AdminResortPartnerManagementPage> createState() =>
      _AdminResortPartnerManagementPageState();
}

class _AdminResortPartnerManagementPageState
    extends State<AdminResortPartnerManagementPage> {
  ...
  Future<void> _approve(
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: const Text('Approve Resort Partner'),
          content: Text(
            'Approve ${_partnerName(doc.data())}?\n\n'
            'After approval this partner can use the Resort Partner system.',
          ),
          actions: <Widget>[
            TextButton(
              onPressed: () =>
    ...
    await _safeUpdate(
      ...
      successMessage: 'Resort Partner approved.',
    );
  }
  ...
  Future<void> _setActive(
    ...
    await _safeUpdate(
      ...
      successMessage: active
          ? 'Resort Partner activated.'
          : 'Resort Partner deactivated.',
    );
  }
  ...
  Future<void> _reject(
    ...
    final String? reason = await showDialog<String>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: const Text('Reject Resort Partner'),
          content: TextField(
    ...
    await _safeUpdate(
      ...
      successMessage: 'Resort Partner rejected.',
    );
  }
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            content: Text(
              'Could not update Resort Partner.\n$error',
            ),
          ),
        );
    }
            ...
            if (snapshot.hasError) {
              return Center(
                child: Padding(
                  ...
                  child: Text(
                    'Could not load Resort Partners.\n'
                    '${snapshot.error}',
