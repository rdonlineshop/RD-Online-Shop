...
class AdminHomestayPartnerManagementPage extends StatefulWidget {
  const AdminHomestayPartnerManagementPage({super.key});

  @override
  State<AdminHomestayPartnerManagementPage> createState() =>
      _AdminHomestayPartnerManagementPageState();
}

class _AdminHomestayPartnerManagementPageState
    extends State<AdminHomestayPartnerManagementPage> {
  ...
  Future<void> _approve(
    ...
    final bool? confirm = await showDialog<bool>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: const Text('Approve Homestay Partner'),
          content: Text(
            'Approve ${_partnerName(doc.data())}?\n\n'
            'After approval this partner can use the Homestay Partner system.',
          ),
          actions: <Widget>[
            TextButton(
              onPressed: () =>
    ...
    await _safeUpdate(
      ...
      successMessage: 'Homestay Partner approved.',
    );
  }
  ...
  Future<void> _setActive(
    ...
    await _safeUpdate(
      ...
      successMessage: active
          ? 'Homestay Partner activated.'
          : 'Homestay Partner deactivated.',
    );
  }
  ...
  Future<void> _reject(
    ...
    final String? reason = await showDialog<String>(
      ...
      builder: (BuildContext dialogContext) {
        return AlertDialog(
          title: const Text('Reject Homestay Partner'),
          content: TextField(
    ...
    await _safeUpdate(
      ...
      successMessage: 'Homestay Partner rejected.',
    );
  }
    ...
    try {
      ...
      ScaffoldMessenger.of(context)
        ...
        ..showSnackBar(
          SnackBar(
            content: Text(
              'Could not update Homestay Partner.\n$error',
            ),
          ),
        );
    }
            ...
            if (snapshot.hasError) {
              return Center(
                child: Padding(
                  ...
                  child: Text(
                    'Could not load Homestay Partners.\n'
                    '${snapshot.error}',
