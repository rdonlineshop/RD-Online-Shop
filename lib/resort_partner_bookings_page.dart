...
class ResortPartnerBookingsPage
  ...
  @override
  State<ResortPartnerBookingsPage>
      createState() =>
          _ResortPartnerBookingsPageState();
}

class _ResortPartnerBookingsPageState
    extends State<ResortPartnerBookingsPage> {
      ...
      await FirebaseFirestore.instance
        ...
        (Transaction transaction) async {
          ...
          if (!roomDoc.exists ||
              ...
              room['isActive'] != true) {
            throw StateError(
              'Room is not active for this resort.',
            );
          }
        ...
        child: Column(
          ...
          children: <Widget>[
            ...
            if (data['paymentOption'] ==
                'direct_resort_online') ...<Widget>[
              const SizedBox(height: 5),
              Text(
                'Direct Resort Payment: ${data['paymentMethod'] ?? ''}',
                style: const TextStyle(
