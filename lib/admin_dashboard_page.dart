  ...
  void _openHomestayDashboard(
    ...
    _openGroupDashboard(
      ...
      cards: <Widget>[
        ...
        _dashboardCard(
          icon: Icons.business_center_rounded,
          title: 'Homestay Partners',
          onTap: () =>
              Navigator.push<void>(
            context,
            MaterialPageRoute<void>(
              builder: (_) =>
                  const AdminHomestayPartnerManagementPage(),
            ),
          ),
        ),
        _dashboardCard(
    ...
    _openGroupDashboard(
      ...
      cards: <Widget>[
        ...
        _dashboardCard(
          ...
          title: 'Universal Test Access',
          onTap: () =>
              Navigator.push<void>(
            context,
            MaterialPageRoute<void>(
              builder: (_) =>
                  const UniversalTestAccessPage(),
            ),
          ),
        ),
      ],
